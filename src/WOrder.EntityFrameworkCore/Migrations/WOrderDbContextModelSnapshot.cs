...
namespace WOrder.Migrations
{
    ...
    partial class WOrderDbContextModelSnapshot : ModelSnapshot
    {
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Order", b =>
                {
                    ...
                    b.HasOne("WOrder.Domain.Entities.WOrder_Account", "HandleUser")
                        .WithMany()
                        .HasForeignKey("HandleUId");
