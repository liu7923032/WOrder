...
namespace WOrder.Migrations
{
    ...
    [Migration("20180421104535_change_transport")]
    partial class change_transport
    {
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Transport", b =>
                {
                    ...
                    b.HasOne("WOrder.Domain.Entities.WOrder_Account", "TransUser")
                        .WithMany()
                        .HasForeignKey("TransUserId");
                });
