...
namespace WOrder.Migrations
{
    ...
    [Migration("20180421093816_add_transport")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Account", b =>
                {
                    ...
                    b.Property<long?>("WOrder_TransportId");
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Transport", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();

                    b.Property<int?>("AcceptUID");

                    b.Property<long?>("AcceptUserId");
                    ...
                    b.ToTable("WOrder_Transport");
                });

            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_TranUser", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Account", b =>
                {
                    ...
                    b.HasOne("WOrder.Domain.Entities.WOrder_Transport")
                        .WithMany("Users")
                        .HasForeignKey("WOrder_TransportId");
                });
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_Transport", b =>
                {
                    b.HasOne("WOrder.Domain.Entities.WOrder_Account", "AcceptUser")
                        .WithMany()
            ...
            modelBuilder.Entity("WOrder.Domain.Entities.WOrder_TranUser", b =>
                {
                    b.HasOne("WOrder.Domain.Entities.WOrder_Transport", "Transport")
                        .WithMany()
